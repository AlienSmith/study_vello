...
impl Render {
    ...
    pub fn render_encoding_coarse(
        ...
        #[cfg(feature = "coarse_segmentation")]
        let coarse_counter_buf = ResourceProxy::new_buf(
            buffer_sizes.coarse_counter.size_in_bytes().into(),
            "coarse_counter_buf"
        );
        #[cfg(feature = "coarse_segmentation")]
        ...
        recording.dispatch(shaders.pathtag_reduce, wg_counts.path_reduce, [
            config_buf,
            scene_buf,
            reduced_buf,
        ]);
        ...
        if wg_counts.use_large_path_scan {
            ...
            recording.dispatch(shaders.pathtag_reduce2, wg_counts.path_reduce2, [
                reduced_buf,
                reduced2_buf,
            ]);
            ...
            recording.dispatch(shaders.pathtag_scan1, wg_counts.path_scan1, [
                reduced_buf,
                reduced2_buf,
                reduced_scan_buf,
            ]);
        ...
        recording.dispatch(pathtag_scan, wg_counts.path_scan, [
            config_buf,
            scene_buf,
            pathtag_parent,
            tagmonoid_buf,
        ...
        let cubic_buf = ResourceProxy::new_buf(
            buffer_sizes.cubics.size_in_bytes().into(),
            "cubic_buf"
        );
        ...
        recording.dispatch(shaders.pathseg, wg_counts.path_seg, [
            config_buf,
            camera_buf,
            scene_buf,
            tagmonoid_buf,
        ...
        recording.dispatch(shaders.draw_reduce, wg_counts.draw_reduce, [
            config_buf,
            scene_buf,
            draw_reduced_buf,
        ]);
        ...
        if wg_counts.clip_reduce.0 > 0 {
            recording.dispatch(shaders.clip_reduce, wg_counts.clip_reduce, [
                clip_inp_buf,
                path_bbox_buf,
                clip_bic_buf,
                clip_el_buf,
        ...
        if wg_counts.clip_leaf.0 > 0 {
            recording.dispatch(shaders.clip_leaf, wg_counts.clip_leaf, [
                config_buf,
                clip_inp_buf,
                path_bbox_buf,
                clip_bic_buf,
        ...
        recording.dispatch(shaders.binning, wg_counts.binning, [
            config_buf,
            draw_monoid_buf,
            path_bbox_buf,
            clip_bbox_buf,
        ...
        recording.dispatch(shaders.tile_alloc, wg_counts.tile_alloc, [
            config_buf,
            scene_buf,
            draw_bbox_buf,
            bump_buf,
        ...
        recording.dispatch_indirect(shaders.path_coarse, indirect_count_buf, 0, [
            config_buf,
            camera_buf,
            scene_buf,
            cubic_buf,
        ...
        let mut run_coarse = || {
            recording.dispatch(shaders.coarse_original, wg_counts.coarse, [
                config_buf,
                scene_buf,
                draw_monoid_buf,
                bin_header_buf,
        ...
        #[cfg(feature = "coarse_segmentation")]
        let mut run_coarse = || {
            recording.dispatch(shaders.coarse_counter, wg_counts.coarse_counter, [
                config_buf,
                scene_buf,
                draw_monoid_buf,
                bin_header_buf,
            ...
            recording.dispatch(shaders.coarse_setup, wg_counts.coarse, [
                config_buf,
                bump_buf,
                coarse_counter_buf,
                coarse_info_buf,
    ...
    pub fn record_fine(&mut self, shaders: &FullShaders, recording: &mut Recording) {
        ...
        #[cfg(feature = "coarse_segmentation")]
        {
            recording.dispatch_indirect(shaders.fine, fine.indirect_dispatch_count, 0, [
                fine.config_buf,
                fine.scene_buf,
                fine.tile_buf,
                fine.segments_buf,
        ...
        #[cfg(not(feature = "coarse_segmentation"))]
        {
            ...
            {
                recording.dispatch(shaders.fine, fine_wg_count, [
                    fine.config_buf,
                    fine.scene_buf,
                    fine.segments_buf,
                    fine.ptcl_buf,
        ...
        recording.free_resource(fine.draw_monoid_buf);
    ...
    pub fn bump_buf(&self) -> BufProxy {
        *self.fine_resources.as_ref().unwrap().bump_buf.as_buf().unwrap()
    }
}
